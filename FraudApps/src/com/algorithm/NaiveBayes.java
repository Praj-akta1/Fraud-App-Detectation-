 ...
 */
public abstract class NaiveBayes<T, K> implements IFeatureProbability<T, K> {
    ...
    public void reset() {
        this.featureCountPerCategory =
                new Hashtable<K, Dictionary<T,Integer>>(
                        NaiveBayes.INITIAL_CATEGORY_DICTIONARY_CAPACITY);
        this.totalFeatureCount =
                new Hashtable<T, Integer>(
                        NaiveBayes.INITIAL_FEATURE_DICTIONARY_CAPACITY);
     ...
     * probability.
     *
     * @see de.daslaboratorium.machinelearning.classifier.NaiveBayes#featureProbability(Object, Object)
     * @see de.daslaboratorium.machinelearning.classifier.NaiveBayes#featureWeighedAverage(Object, Object, IFeatureProbability, float, float)
     *
