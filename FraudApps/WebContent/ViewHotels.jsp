...
<center><h2>Fraud apps detection using sentiment analysis and spam filtering</h2></center>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
         ...
         <div id="page-wrapper">
            <div class="row">
              <h4 class="text-upper col-md-offset-0" ><center><b>Hotel Details Table</b></center></h4><br>
                   <form class="subscription-form">
                    ...
                    <th> Hotel Name   </th>
                     ...
                     ResultSet rs=st.executeQuery("select * from tbl_hotels");
                     while(rs.next())
                     {
                    	 %>
                    	 <TR>
               		...
               		<TD> <%= rs.getString(8) %></TD>
                    	 ...
                    	 <td><a href="<%= rs.getString(10) %>?id=<%=rs.getString(1)%>">View</a></td>
               		
               		<TD> <a href="UserGiveHotelReview.jsp?ID=<%= rs.getString(1)%>">Give Review</a></TD>
               		<TD> <a href="UserViewHotelReview.jsp?ID=<%= rs.getString(1)%>">View Reviews</a></TD>
                    	 </TR>
