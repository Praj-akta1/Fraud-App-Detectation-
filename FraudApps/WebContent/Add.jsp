				...
				<div class="col-md-4 col-md-offset-4">
					<div class="login-panel panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Add App Data</h3>
						</div>
						<div class="panel-body">
							<form role="form" action="AddLocationController" method="post" enctype="multipart/form-data">
								<fieldset>
									...
									<div class="form-group">
										<input class="form-control" placeholder="App Name"
											name="loc_name" type="text">
									</div>

									<div class="form-group">
										<input class="form-control" placeholder="App Type"
											name="loc_type" type="text">
									</div>
